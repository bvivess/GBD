...
CREATE TABLE order_status_tab( 
	...
	CONSTRAINT order_status_tab_pk PRIMARY KEY (order_status_id)
);

-- STEP 2
ALTER TABLE customers DROP CONSTRAINT ORDER_STATUS_CK;

-- STEP 3
-- Versión 1
INSERT INTO order_status_tab( order_status_id, status_description )
...
-- STEP 4
ALTER TABLE orders RENAME COLUMN order_status TO order_status_id;
ALTER TABLE orders ADD CONSTRAINT ord_ost_fk
	FOREIGN KEY (order_status) REFERENCES order_status_tab(order_status_id);
